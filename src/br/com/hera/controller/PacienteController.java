        ...
        if (pacientes.isEmpty()) {
            ...
            for (Object object : pacientes) {
                ...
                resposta += "Id: " + paciente.getId()
                        ...
                        + " | Telefone ID: " + paciente.getTelefone().getId()
                        ...
                        + " | Acompanhante ID: " + paciente.getAcompanhante().getId()
                        + " | Telefone Acompanhante ID: " + paciente.getAcompanhante().getTelefone().getId()
                        + "\n";
            }
        }
