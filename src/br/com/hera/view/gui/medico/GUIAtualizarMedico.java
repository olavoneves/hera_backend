...
public class GUIAtualizarMedico extends JPanel {
    private JLabel lbIdMedico, lbIdTelefone;
    private JTextField tfIdMedico, tfIdTelefone;
    ...
    private void inicializarComponentes() {
        ...
        lbIdMedico = new JLabel("ID Paciente:");
    ...
    private void definirEventos() {
        btAtualizar.addActionListener(e -> {
            try {
                ...
                String resposta = medicoController.alterarMedico(
                        Integer.parseInt(tfIdMedico.getText()), tfNome.getText(), tfCrm.getText(), tfEspecialidade.getText(), tfEmail.getText(), telefone, Integer.parseInt(tfCargaHorariaSemanal.getText()), tfStatus.getText()
                );
    ...
    private void limparCampos() {
        tfIdMedico.setText(""); tfIdTelefone.setText("");
