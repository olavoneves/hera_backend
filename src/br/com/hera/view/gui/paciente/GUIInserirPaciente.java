...
public class GUIInserirPaciente extends JPanel {
    private JLabel lbNome, lbEmail, lbSexo, lbDDD, lbNumero, lbTipo, lbStatus, lbConsultasRestantes, lbFaltas, lbPossuiDeficiencia, lbTipoDeficiencia, lbVideoEnviado, lbDataNascimento, lbEndereco, lbPreferenciaContato, lbDataCadastro, lbUltimaAtualizacao, lbAcompanhante, lbParentesco, lbDDD_Acomp, lbNumero_Acomp, lbTipo_Acomp;
    private JTextField tfNome, tfEmail, tfSexo, tfDDD, tfNumero, tfTipo, tfStatus, tfConsultasRestantes, tfFaltas, tfTipoDeficiencia, tfDataNascimento, tfEndereco, tfPreferenciaContato, tfDataCadastro, tfUltimaAtualizacao, tfAcompanhante, tfParentesco, tfDDD_Acomp, tfNumero_Acomp, tfTipo_Acomp;
    ...
    private void definirEventos() {
        btInserir.addActionListener(e -> {
            try {
                ...
                telefoneAcomp.setId(telefoneController.inserirTelefone(telefoneAcomp));
                ...
                acompanhante.setId(acompanhanteController.inserirAcompanhante(acompanhante));
    ...
    private void limparCampos() {
        tfNome.setText(""); tfEmail.setText(""); tfSexo.setText(""); tfDDD.setText(""); tfNumero.setText("");
        tfTipo.setText(""); tfStatus.setText(""); tfConsultasRestantes.setText(""); tfFaltas.setText("");
        ...
        tfAcompanhante.setText(""); tfParentesco.setText(""); tfDDD_Acomp.setText(""); tfNumero_Acomp.setText("");
        tfTipo_Acomp.setText(""); cbAtivo.setSelected(false); cbPreferencial.setSelected(false);
